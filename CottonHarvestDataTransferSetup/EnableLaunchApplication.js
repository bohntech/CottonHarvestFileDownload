...
var checkboxText = "Launch Cotton Harvest Download Utility";	// Text for the checkbox on the finished dialog
var filename = "CottonHarvestDataTransferApp.exe";	// The name of the executable to launch - change this to match the file you want to launch at the end of your setup
